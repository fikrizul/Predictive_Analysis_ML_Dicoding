...
Original file is located at
    https://colab.research.google.com/drive/1Kj39fLnJfG7Eu47UbDKCWQUpveq1Fy0C
...
Pembuatan data untuk `Model Optimasi Pengeluaran Energi` yaitu dengan mendrop kolom Kalori Terbakar dari keseluruhan Data untuk membentuk nilai X sebagai variabel bebas. Semua kolom digunakan kecuali kolom Kalori Terbakar yang akan digunakan sebagai y atau variabel terikat.
"""
...
Proses pembuatan data untuk Model Penyesuaian Kadar Lemak Tubuh dilakukan dengan menghapus kolom Kadar Lemak Tubuh dari seluruh dataset, sehingga menghasilkan nilai X sebagai variabel independen. Semua kolom lainnya digunakan, kecuali kolom Kadar Lemak Tubuh yang akan menjadi variabel dependen atau y.
"""
